...
public class FurniDataTools {
    ...
    private static final Set<String> UNSTACKABLE_FURNI =
            new HashSet<>(
                    Arrays.asList(
                            "fball_gate",
                            "es_tile",
    ...
    private String furnidataUrl() {
        ...
        return String.format(
                "https://www.habbo%s/gamedata/furnidata_json/1", codeToDomainMap.get(countryCode));
    }
    ...
    public String getWallItemName(int typeId) {
        return typeIdToNameWall.get(typeId);
    }
