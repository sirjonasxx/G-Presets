...
public class AvailabilityChecker {
    ...
    public static Map<String, Integer> missingItems(List<FurniDropInfo> furniDrops, Inventory inventory, BCCatalog catalog, FurniDataTools furniDataTools, FloorState floorState) {
    ...
    public static void printAvailability(Logger logger, List<FurniDropInfo> furniDrops, Inventory inventory, BCCatalog catalog, FurniDataTools furniDataTools, FloorState floorState) {

        Map<String, Integer> missing = missingItems(furniDrops, inventory, catalog, furniDataTools, floorState);
        if (inventory.getState() == Inventory.InventoryState.LOADED
                && catalog.getState() == BCCatalog.CatalogState.COLLECTED
