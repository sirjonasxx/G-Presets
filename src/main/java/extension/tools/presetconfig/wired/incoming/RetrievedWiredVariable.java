...
public class RetrievedWiredVariable extends PresetWiredVariable implements RetrievedWired {
    ...
    public RetrievedWiredVariable(int wiredId, List<Integer> options, String stringConfig, List<Integer> items, int typeId, List<Integer> pickedFurniSources, List<Integer> pickedUserSources, List<Long> variableIds) {
